            ...
            <Card key={loc.locationId} className="card-premium">
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="font-display text-xl text-foreground">{loc.locationId === 'trowbridge' ? 'The Lamb On the Strand' : loc.locationId === 'salisbury' ? 'Salisbury' : 'Westbury'}</CardTitle>
